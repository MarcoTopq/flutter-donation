...
class _CampaignDetailState extends State<CampaignDetail>
  ...
  @override
  void initState() {
    fundraiserController.text = widget.fundraiser;
    emailController.text = widget.email;
    titleController.text = widget.title;
    _mySelection = widget.category;
    descriptionController.text = widget.description;
    totaldonationController.text = widget.totalDonation;
    timelimitController.text = widget.timeLimit;
    super.initState();
  ...
  Future<http.Response> kirimdata(File file) async {
    ...
    http.Response hasil = await http.post(
        Uri.decodeFull(urls + "/campaigns/" + widget.id.toString()),
        body: {
          ...
          "image": res['image'],
          "current_donation": widget.currentDonation.toString(),
  ...
  Future<http.Response> senddata() async {
    ...
    http.Response hasil =
        await http.post(Uri.decodeFull(urls + "/campaigns/" + widget.id),
            body: {
              "fundraiser": fundraiserController.text,
              "email": emailController.text,
              "title": titleController.text,
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    isDense: true,
                                    value: _mySelection,
                                    hint: Text(widget.category.toString()),
                                  ...
                                  if (files == null) {
                                    senddata().then((value) async {
                                      if (value.statusCode == 200) {
                                        ...
                                        Toast.show(
                                            "Campaign berhasil diubah", context);
